...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2024 a las 01:02:19
...
INSERT INTO `usuario` (`Id`, `nombre`, `apellido`, `id_rol`, `email`, `password`, `estado`) VALUES
(1, 'admin', 'Sammarco', 1, 'admin@admin.com', '123', '1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuario_has_logs`
--

CREATE TABLE `usuario_has_logs` (
  `Usuario_Id` int(11) NOT NULL,
  `logs_idLog` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Indices de la tabla `usuario_has_logs`
--
ALTER TABLE `usuario_has_logs`
  ADD PRIMARY KEY (`Usuario_Id`,`logs_idLog`);
